...
<body class="mybody1 bodytop">
    <div class="container">
        <p id="success"></p>
        <div class="table-wrapper">
            <div class="table-title my-3 text-center">
                        <h1><b>Danh sách các công ty</b></h1>
            </div>
            <div class="table-responsive" style="overflow: visible; margin-top: 12px;">
                <table class="table custom-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['address_comp']; ?></td>
                        <td><?php echo $row['info_comp']; ?></td>
                        <td><?php echo $row['website_comp']; ?></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                </table>
    ...
    <form class="delete"  action="delete_company.php" method="GET">
