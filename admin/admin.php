...
<body>
    <nav class="navbar navbar-expand-sm nav-1">
        <div class="container">
            <a class="navbar-brand" href="admin.php"><b>JobCV</b></a>
            ...
            <ul class="nav navbar-nav navbar-right ">
                <li class="nav-item">
                    ...
                    <a href="../company/company.php"><button type="button" class="btn btn-light" style="text-decoration:none;color: black ">Trang Đăng Việc</button></a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="form mt-4 p-3">
        <form class="login-form " action="login.php" method="post">
            <p style="text-align:center; font-weight:bold; font-size:20px;"> TRANG QUẢN LÝ CỦA ADMIN </p> </br>
            <input type="text" name="username" placeholder="Nhập tài khoản email" /> </br>
